...
def difference_abstract_data_containers(abstract_data_container1: AbstractDataContainer, \
    ...
    if _check_that_objects_are_members_of_class_abstract_data_container(\
        abstract_data_container1, abstract_data_container2):
        return _calculate_difference(abstract_data_container1, abstract_data_container2)
    else:
        raise TypeError

def _check_that_objects_are_members_of_class_abstract_data_container(\
    abstract_data_container1: AbstractDataContainer, \
    abstract_data_container2:AbstractDataContainer) -> bool:
...
def _calculate_difference(abstract_data_container1: AbstractDataContainer, \
    ...
    if abstract_data_container1._is_dictionary and abstract_data_container2._is_dictionary:
        return _calculate_difference_if_containers_are_dictionaries(\
            abstract_data_container1, abstract_data_container2)
    elif abstract_data_container1._is_list and abstract_data_container2._is_list:
        return _calculate_difference_if_containers_are_lists(\
            abstract_data_container1, abstract_data_container2)
    else:
        raise TypeError
