...
class any2json:
    ...
    def matpower2json(self, folder_path=None, name_matpower=None, name_json=None):
        ...
        # # add for pandapower only:
        # # "min_p_mw": [],
        # # "max_p_mw": [],
        # # "min_q_mvar": [],
        # # "max_q_mvar": []
        # jsonformat['gen']['min_p_mw'] = jsonformat['gen']['PMIN']
        # jsonformat['gen']['max_p_mw'] = jsonformat['gen']['PMAX']
        # jsonformat['gen']['min_q_mvar'] = jsonformat['gen']['QMIN']
        # jsonformat['gen']['max_q_mvar'] = jsonformat['gen']['QMAX']
