...
def test_load_parameters_power_system_optimisation():
    file_path = 'C:\\Users\\f09903jm\\git projects\\pyensys\\tests\\json\\pandapower_test_conf.json'
    parameters_ps = ReadJSON()
    parameters_ps.read_parameters_power_system_optimisation(file_path)
    assert parameters_ps.date_time_optimisation_settings.initialised
    assert parameters_ps.output_settings.initialised
    assert parameters_ps.pandapower_mpc_settings.initialised
    assert parameters_ps.pandapower_optimisation_settings.initialised
    assert parameters_ps.problem_settings.initialised
    assert parameters_ps.profiles_data.initialised
